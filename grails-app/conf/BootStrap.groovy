...
class BootStrap {
    ...
    def init = { servletContext ->
		...
		if(Environment.current == Environment.DEVELOPMENT) {
			...
			def kalles = new Page(title: 'Kalles sida', pageOrder: 1, permalink: 'kalle', h1: 'heja kalle!', content: "Första försöket", status: "published", publishStart: new Date() - 4).save()
			...
			new Page(title: 'Lagrummet', pageOrder: 0, permalink: 'home', h1: 'Välkommen till lagrummet.se', content: "Första försöket", status: "published", publishStart: new Date() - 4).save()
