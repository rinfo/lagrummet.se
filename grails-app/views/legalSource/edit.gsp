                ...
                <div class="dialog">
                    <table>
                        <tbody>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="name"><g:message code="legalSource.name.label" default="Namn" /></label>
                                </td>
                            ...
                            <tr class="prop">
                                <td valign="top" class="name">
                                  <label for="grouping"><g:message code="legalSource.grouping.label" default="Grupp" /></label>
                                </td>
