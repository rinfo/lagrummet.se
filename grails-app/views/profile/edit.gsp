<html>
    ...
    <body>
        <div class="body">
            ...
            <g:form action="updateProfile" useToken="true">
                <g:render template="userProfileForm" />
                
                <div class="buttons">
                    <span class="button"><g:submitButton name="update" class="updateProfile" value="${message(code: 'default.button.update.label', default: 'Update')}" /></span>
                </div>
            </g:form>
	    </div>
    </body>
