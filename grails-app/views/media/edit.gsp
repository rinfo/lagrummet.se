	         ...
	         <g:form method="post" useToken="true">
				...
				<div class="input ${hasErrors(bean: mediaInstance, field: 'title', 'errors')}">
	             ...
	             <div class="buttons">
	                 ...
	                 <span class="button"><g:actionSubmit class="delete" action="delete" value="${message(code: 'default.button.delete.label', default: 'Delete')}" onclick="return confirm('${message(code: 'media.button.delete.confirm.message', args:[mediaInstance.title], default: 'Are you sure?')}');" /></span>
	             </div>
	         </g:form>
    </body>
</html>
