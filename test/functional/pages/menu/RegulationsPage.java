...
public class RegulationsPage extends BasePage<RegulationsPage> {
    ...
    @Override
    public boolean isAt() {
        return  SeleniumDriver.isDisplayed(getDriver().findElement(By.xpath("//div[@id='content']/article/header/h1[contains(text(), 'Myndigheters föreskrifter')]")));
    }

    @Override
    public String getUrl() {
        return "/rattsinformation/myndigheters-foreskrifter";
    }
