...
public class InternationalMaterialPage extends BasePage<InternationalMaterialPage> {
    ...
    @Override
    public boolean isAt() {
        return  SeleniumDriver.isDisplayed(getDriver().findElement(By.xpath("//div[@id='content']/article/header/h1[contains(text(), 'Internationellt material')]")));
    }

    @Override
    public String getUrl() {
        return "/rattsinformation/internationellt-material";
    }
